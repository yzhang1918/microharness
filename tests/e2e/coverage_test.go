...
var canonicalTransitionFamilies = []transitionFamily{
	...
	{ID: "step_implement_to_explicit_earlier_review", From: "execution/step-<n>/implement", To: "execution/step-<i>/review", Driver: "`harness review start` with explicit `step=<i>`", RequiredInputs: "Earlier completed step `<i>` intentionally needs closeout repair"},
	...
	{ID: "explicit_earlier_review_to_step_implement_repair", From: "execution/step-<i>/review", To: "execution/step-<i>/implement", Driver: "harness review aggregate", RequiredInputs: "Earlier-step repair aggregate has actionable findings or an unrecoverable conservative outcome"},
	{ID: "explicit_earlier_review_to_ordinary_frontier", From: "execution/step-<i>/review", To: "`execution/step-<m>/implement` or `execution/finalize/...`", Driver: "harness review aggregate", RequiredInputs: "Earlier-step repair aggregate is clean"},
	...
	{ID: "finalize_review_to_explicit_earlier_review", From: "execution/finalize/review", To: "execution/step-<i>/review", Driver: "`harness review start` with explicit `step=<i>`", RequiredInputs: "Earlier completed step `<i>` intentionally needs closeout repair before finalize can be trusted"},
	...
	{ID: "finalize_fix_to_explicit_earlier_review", From: "execution/finalize/fix", To: "execution/step-<i>/review", Driver: "`harness review start` with explicit `step=<i>`", RequiredInputs: "Earlier completed step `<i>` intentionally needs closeout repair during finalize-scope repair"},
...
var currentScenarioCoverage = []scenarioCoverage{
	...
	{
		ID:       "explicit_step_repair",
		TestName: "TestExplicitStepRepairTransitionsWithBuiltBinary",
		TransitionIDs: []string{
			"plan_to_step_implement",
			"step_implement_to_next_step_implement",
			"step_implement_to_explicit_earlier_review",
			"explicit_earlier_review_to_step_implement_repair",
			"explicit_earlier_review_to_ordinary_frontier",
			"step_implement_to_finalize_review",
			"finalize_review_to_explicit_earlier_review",
			"finalize_review_to_finalize_fix",
			"finalize_fix_to_explicit_earlier_review",
		},
	},
}
