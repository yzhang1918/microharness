...
func TestLandWorkflowWithBuiltBinary(t *testing.T) {
	...
	land := support.Run(t, workspace.Root, "land", "--pr", "https://github.com/yzhang1918/microharness/pull/99", "--commit", "abc123")
	...
	if inLandStatus.Facts.LandPRURL != "https://github.com/yzhang1918/microharness/pull/99" {
